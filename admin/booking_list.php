    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th>หลักฐานการชำระเงิน</th> <!-- เพิ่มคอลัมน์สำหรับแสดงหลักฐานการชำระเงิน -->
                <th>จัดการ</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php 
                        if (!empty($booking['payment_slip'])) { // ตรวจสอบว่ามี path รูปภาพ
                            $imgPath = htmlspecialchars($booking['payment_slip']);
                            // ปรับ path ให้เป็น URL ที่สามารถเข้าถึงได้จาก root
                            $imgUrl = "http://localhost/projectRentRoom/rooms/" . $imgPath;
                            echo '<img src="' . $imgUrl . '" alt="Payment Slip" style="width: 100px; height: auto;">';
                        } else {
                            echo "ยังไม่มีหลักฐานการชำระเงิน";
                        }
                    ?>
